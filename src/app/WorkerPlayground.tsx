...
<div
  ...
  style={{
    ...
    height: 286,
    borderRadius: '17.5px',
    background: personalityEmotionQuotes[result.id].background,
    zIndex: 5,
    display: 'flex',
...
>
  ...
  <div
    style={{
      ...
      background: personalityEmotionQuotes[result.id].headerBg,
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center'
    }}
  >
    <div
      style={{
        ...
        lineHeight: '61.25px',
        letterSpacing: '2.1px',
        color: personalityEmotionQuotes[result.id].headerTextColor,
      }}
    >
      情緒宣言
    </div>
  ...
  <div
    style={{
      ...
      lineHeight: '61.25px',
      letterSpacing: '2.1px',
      color: personalityEmotionQuotes[result.id].textColor,
    }}
  >
    {personalityEmotionQuotes[result.id].content}
  </div>
</div>


{result && personalityRelations[result.id] && (
  <>
    {/* 互相治癒區塊 */}
    <div
      className="absolute"
      style={{
        ...
        background: relationBlockBackground[result.id], // 這邊我接下來給你
        zIndex: 10
      }}
    >
      {/* 標題底框 */}
      <div
        style={{
          width: '467.15px',
          height: '85.75px',
          background: relationHeaderBackground[result.id],
          borderRadius: '17.5px 17.5px 0px 0px',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
      ...
      <div style={{
        ...
        {personalityRelations[result.id].heal.map((charId: string) => (
          <img
            key={charId}
            src={`/icon-${charId}.png`}
            alt={charId}
    ...
    <div
      ...
      style={{
        ...
        borderRadius: '17.5px',
        border: '0.875px solid #FFF',
        background: relationBlockBackground[result.id],
        zIndex: 10
      }}
    >
      {/* 標題底框 */}
      ...
      <div style={{
        ...
        {personalityRelations[result.id].hurt.map((charId: string) => (
          <img
            key={charId}
            src={`/icon-${charId}.png`}
            alt={charId}
